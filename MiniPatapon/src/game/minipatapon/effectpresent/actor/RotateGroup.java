...
public class RotateGroup extends Group {
	...
	public void setState(Actor actor, boolean left, int i) {
		...
		actor.action(Parallel.$(ScaleTo.$(scales[nextIndex], scales[nextIndex],
				1f), QuadTo.$(points[nextIndex], controlVectors[controlI], 1f)));
