...
public class MathHelper {
	...
	public static Vector2 getQuadCurve(Vector2 startVector, Vector2 controlVector, Vector2 endVector, float t)
	{
		float x = (1-t)*(1-t)*startVector.x + 2*t*(1-t)*controlVector.x + t*t*endVector.x;
		float y = (1-t)*(1-t)*startVector.y + 2*t*(1-t)*controlVector.y + t*t*endVector.y;
		
		return new Vector2(x, y);
	}
	
	public static Vector2 getCubicCurve(Vector2 startVector, Vector2 control1, Vector2 control2, Vector2 endVector, float t)
	{
		float x = (1-t)*(1-t)*(1-t)*startVector.x + 3*t*(1-t)*(1-t)*control1.x + 3*t*t*(1-t)*control2.x + t*t*t*endVector.x;
